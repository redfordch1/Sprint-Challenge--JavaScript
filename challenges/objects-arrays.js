...
graduates.forEach(function(value){
  return universities.push(`${value.university}`);
})
...
zooAnimals.forEach((value) =>{
  return displayNames.push(`${value.animal_name}, Scientific: ${value.scientific_name}.`);
})
...
lowCaseAnimalNames = zooAnimals.map((value) =>{
...
lowPopulationAnimals = zooAnimals.filter((value) =>{
...
populationTotal = zooAnimals.reduce((value, pop) => {return value + pop.population},0);
