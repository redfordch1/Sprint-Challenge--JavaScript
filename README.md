...
.forEach does something for each of peice of data. .map runs over all of the data and pulls out whatever you tell it to.
...
It is used in order to call the methods of the parent class. 
